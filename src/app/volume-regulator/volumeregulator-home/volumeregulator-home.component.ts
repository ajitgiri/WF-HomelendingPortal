...
export class VolumeregulatorHomeComponent {
  ...
  goToVolumeDetails(){
    ...
    this.router.navigate(['/portalHome/vr/volumeregulatorDetails']);
  }

  goToVolumeRegulatorDetailsList(){
    alert("navigate to Volume Regulator List Page");
    this.router.navigate(['/portalHome/vr/volumeregulatorList']);
  }
